    ...
    <div class="container">
      <div class="recapture-wrapper">
        <div class="recapture-content">
          <p>
             {{trans("default.verify_yourself")}}
          </p>
          <div
            class="d-flex align-items-center justify-content-between gap-3">
    
                <a id='genarate-captcha' class="align-middle justify-content-center cursor-pointer">
                    <img class="captcha-default d-inline me-2 cursor-pointer  " src="{{ route('captcha.genarate',1) }}" id="default-captcha">
        ...
        <div class="recapture-bg">
            <img src="{{asset('assets/images/security.jpg')}}" alt="security.jpg">
        </div>
  </div>
