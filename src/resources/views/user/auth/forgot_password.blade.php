            ...
            <div class="row g-0">
                ...
                <div class="col-lg-6">
                    <div class="login-form-area">
                        ...
                        <form action="{{route('password.email')}}" class="login-right-form" method="post">
                            @csrf
                            ...
                            <div class="input-type">
                                ...
                                <div class="form-inner">
                                     <input placeholder="{{translate('Enter EMAIL')}}" name="email"  type="email"  name="otp" class="form-control" >
                                </div>
