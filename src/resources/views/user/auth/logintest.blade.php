            ...
            <div class="form-wrapper">
                <div class="row mb-25 gy-4">
                    <div class="col-md-12 text-center">
                        <a href="{{route('user.home')}}" class="site-logo">
                ...
                <form action="{{route('auth.authenticate')}}" class="login-right-form" method="post">
                    @csrf
                    <div class="row">
                        <div class="col-lg-12">
                        ...
                        <div class="col-lg-12">
                            <div class="form-inner password-inner">
                                ...
                                <input required  type="password"  name="password" class="form-control pe-5 password" placeholder="Enter password" id="password">
                        ...
                        <div class="col-lg-12">
                            <div class="form-inner d-flex justify-content-between align-items-center">
                                ...
                                <a class="forget-pass"  href="{{route('auth.password.request')}}">{{translate("Forgot password")}}?</a>
                            </div>
                        </div>
                        <div class="col-12">
