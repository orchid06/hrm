       ...
       <!-- profile -->
        <div class="header-icon">
          <div class="profile-dropdown">
            ...
            <div class="dropdown-menu dropdown-menu-end">
              <ul>
                <li>  <span class="dropdown-item">{{translate('Welcome')}} {{@$user->name}}!</span></li>
                <li>
                    <a class="dropdown-item" href="{{route('user.profile')}}"> <i class="las la-cog"></i>
                      {{translate("Profile")}}
                    </a>
                </li>
                <li>
                    <a href="{{route('user.logout')}}" class="pointer dropdown-item " >  <i class="las la-sign-out-alt"></i>
                      {{translate('logout')}}
                    </a>
                </li>
              </ul>
