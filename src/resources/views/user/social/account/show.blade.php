                            ...
                            <div class="d-flex justify-content-between align-items-center">
                                ...
                                <div class="social-auth">
                                        ...
                                        <div class="profile-img">
                                            <img  src='{{@$account->account_information->avatar??get_default_img()}}'  onerror="this.onerror=null; this.src='{{ route('default.image', '200x200')}}'"   alt="{{translate('Social profile image')}}"   >
                                        </div>
