                                            ...
                                            <div class="tab-pane fade active show" id="tab-one" role="tabpanel">
                                                ...
                                                <div class="collapse mt-2" id="selectProfile">
                                                    ...
                                                    <select id="profile-select" multiple="multiple"
                                                        style="width: 100%;">
                                                        <option value="1"
                                                            data-image="https://i.ibb.co/VHmD5nt/user2.jpg">Raju Ahmed
                                                        </option>
                                                        <option value="2"
                                                            data-image="https://i.ibb.co/VHmD5nt/user2.jpg">Kamrul Hasan
                                                        </option>
                                                        <option value="3"
                                                            data-image="https://i.ibb.co/VHmD5nt/user2.jpg">polash
                                                        </option>
                                                        <option value="3"
                                                            data-image="https://i.ibb.co/VHmD5nt/user2.jpg">Rakibul
                                                            Islam</option>
                                                        <option value="3"
                                                            data-image="https://i.ibb.co/VHmD5nt/user2.jpg">Nafiz Khan
                                                        </option>
                                                        <option value="3"
                                                            data-image="https://i.ibb.co/VHmD5nt/user2.jpg">Anamul Haque
                                                        </option>
                                                        <option value="3"
                                                            data-image="https://i.ibb.co/VHmD5nt/user2.jpg">Rayhan Ulla
                                                        </option>
                                                        <option value="3"
                                                            data-image="https://i.ibb.co/VHmD5nt/user2.jpg">Nurul Amin
                                                        </option>
                                                        <option value="3"
                                                            data-image="https://i.ibb.co/VHmD5nt/user2.jpg">Nasif Ahmed
                                                        </option>
                                                        <option value="3"
                                                            data-image="https://i.ibb.co/VHmD5nt/user2.jpg">Shakil Khan
                                                        </option>
                                                    </select>
                                                    ...
                                                    <div class="choose-profile-body">
                                                        <ul class="profile-list mt-3" data-simplebar>
                                                            ...
                                                            <li class="profile-item">
                                                                <label for="account-{{$account->id}}">
                                                                    ...
                                                                    <input @if(old('account_id') &&
                                                                        in_array($account->id,@old('account_id')))
                                                                    checked @endif name="account_id[]"
                                                                    id="account-{{$account->id}}"
                                                                    value="{{$account->id}}" class="form-check-input
                                                                    check_account mt-0" name="selected-profile"
                                                                    type="checkbox"
                                                                    data-id="{{$account->id}}"
                                                        ...
                                                        <div class="choose-profile-footer">
                                                            <a href="{{route('user.social.account.list')}}"
                                                        ...
                                                        <div class="col-xl-12 col-md-8">
                                                            <div class="form-inner mb-0">
                                                                <input placeholder="{{translate('Select date time')}}"
                                                                    type="text" class="singleDate flatpickr-input"
                                                                    name="schedule_date"
                                        ...
                                        <div class="row mt-5 mb-4">
                                            <div class="col-md-12">
                                                <div class="form-inner">
                                                    ...
                                                    <input placeholder="{{translate('Select date time')}}" type="text"
                                                        class="singleDate flatpickr-input" name="schedule_date"
                                                        value="{{old('schedule_date')}}" id="time_post" />
                                                </div>
                                            </div>
                                            <div class="col-md-12">
                                                <div class="form-inner">
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-inner">
                                                    ...
                                                    <input placeholder="Repost" id="interval" type="text"
                                                        name="interval" />
                                                </div>
                                            </div>
                                            <div class="col-md-12">
                                                <div class="form-inner">
                                                    ...
                                                    <input placeholder="{{translate('Select date time')}}" type="text"
                                                        class="singleDate flatpickr-input" name="schedule_date"
                                                        value="{{old('schedule_date')}}" id="repost" />
                                                </div>
                                            </div>
                                        </div>
                                        <button type="submit"
                                    ...
                                    <div class="social-preview-body facebook mb-4">
                                        <div class="social-auth">
                                            <div class="profile-img">
                                                <img src="http://localhost/EngageHub/assets/images/default/default.jpg"
                                                    alt="http://localhost/EngageHub/assets/images/default/default.jpg" />
                                            </div>
