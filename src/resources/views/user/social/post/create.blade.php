                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-xxl-8">
                                        ...
                                        <div class="slider-wrap mb-4">
                                            <div class="swiper choose-profile-slider justify-content-center">
                                                <ul class="nav nav-tabs style-1 border-0 swiper-wrapper flex-nowrap"
                                                    ...
                                                    <li class="nav-item swiper-slide" role="presentation">
                                                        <a class="nav-link pb-1" data-bs-toggle="tab"
                                                            href="#tab-{{$platform->slug}}" aria-selected="true"
                                                            role="tab">
                                                            {{$platform->name}}
                                                        </a>
                                                    </li>
                                            ...
                                            <div class="tab-pane fade active show" id="tab-all" role="tabpanel">
                                                ...
                                                <div class="collapse mt-2" id="selectProfile">
                                                    ...
                                                    <select name="account_id[]" multiple="multiple"
                                                        ...
                                                        @php
                                                        $imgUrl =
                                                        isValidImageUrl(@$account->account_information->avatar)
                                                        ? @$account->account_information->avatar
                                                        : route('default.image', '200x200')
                                                        @endphp
                                                            <option @if(old('account_id') && is_array(old('account_id')) &&
                                                                in_array($account->id , old('account_id'))) selected @endif
                                                                value="{{$account->id}}"
                                                                data-image="{{  $imgUrl}}">
                                                                {{$account->name}}
                                                            </option>
                                            ...
                                            @foreach ($platforms as $platform)
                                                <div class="tab-pane fade" id="tab-{{$platform->slug}}" role="tabpanel">
                                                    <div class="choose-profile-btn w-100" role="button"
                                                        ...
                                                        data-bs-target="#select{{$platform->slug}}Profile"
                                                        aria-expanded="false"
                                                        aria-controls="select{{$platform->slug}}Profile">
                                                        <div class="choose-profile-left">
                                                            <i class="bi bi-person-badge"></i>
                                                            {{translate("Select a profile")}}
                                                        </div>
                                                    ...
                                                    <div class="collapse mt-2" id="select{{$platform->slug}}Profile">
                                                        ...
                                                        <div class="choose-profile-body mt-2">
                                                            <div class="choose-profile-footer">
                                                                <a href="{{route('user.social.account.create',['platform' => $platform->slug])}}"
                                            ...
                                            <div class="form-inner mb-0">
                                                <div class="compose-body">
                                                    <textarea name="text" cols="30" rows="4"
                                                        ...
                                                        class="compose-input" id="inputText">{{old('text')}}</textarea>
                                ...
                                <div class="mb-0">
                                    ...
                                    <div class="card-body">
                                        <div class="input-group mb-0">
                                            <input type="text" placeholder="{{translate('Enter link')}}" name="link"
                                                id="link" value="{{old('link')}}" class="form-control" />
                                        </div>
                                    </div>
                                </div>
                                ...
                                <button type="submit" class=" mt-3 i-btn btn--primary btn--lg capsuled postSubmitButton"
                                    id="postSubmitButton">
                                    {{translate("Post")}}
                            ...
                            <div class="swiper social-btn-slider mb-4 justify-content-center">
                                <ul class="nav nav-tabs style-1 border-0 swiper-wrapper flex-nowrap" role="tablist">
                                    ...
                                    @foreach ($platforms as $platform)
                                        <li class="nav-item swiper-slide" role="presentation">
                                            <a class="nav-link pb-1" data-bs-toggle="tab"
                                                href="#tab-preview-{{$platform->slug}}" aria-selected="true" role="tab">
                                                {{
                                                        $platform->name
                                                    }}
                                            </a>
                                    ...
                                    <div class="social-preview-body facebook mb-4">
                                        <div class="social-auth">
                                            <div class="profile-img">
                                                <img src="{{get_default_img()}}" alt="default.jpg" />
                                            </div>
                                            ...
                                            <div class="action-count d-flex justify-content-between align-items-center">
                                                <div class="emoji d-flex align-items-center gap-2">
                                                    <ul class="d-flex gap-0 react-icon-list">
                                                        <li><img src="{{asset('assets/images/default/like.png')}}"
                                                                alt="like.png"></li>
                                                        <li><img src="{{asset('assets/images/default/love.png')}}"
                                                                alt="love.png"></li>
                                                        <li><img src="{{asset('assets/images/default/care.png')}}"
                                                                alt="care.png"></li>
                                                    </ul>
                                                    <span class="fs-14">
                                                        {{translate("129")}}
