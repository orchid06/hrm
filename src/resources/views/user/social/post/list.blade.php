            ...
            <div class="search-action-area">
                <div class="row g-3">
                    ...
                    <div class="col-md-2 d-flex justify-content-start">
                        ...
                        <div class="action">
                            <a href="{{route('user.social.post.create')}}" class="i-btn btn--sm success">
                            ...
                            <tr>
                                ...
                                <td data-label='{{translate("Action")}}'>
                                    <div class="table-action">
                                        ...
                                        <a  title="{{translate("Show")}}"  href="{{route('user.social.post.show',["uid" => $post->uid])}}" class="fs-15 icon-btn success"><i class="bi bi-eye"></i>
                                        </a>
