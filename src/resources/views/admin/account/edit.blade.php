...
@section('content')
@php
    $customInputs = json_decode($account->custom_inputs , true);
@endphp
<div class="i-card-md mb-4">
    <div class="card--header">
        <h4 class="card-title">
            {{ translate('Account Edit From') }}
        </h4>
    </div>
                                    ...
                                    <tr>
                                        <td data-label='{{translate("Key")}}'>
                                            <div class="form-inner mb-0">
                                                <input type="text" name="custom_inputs[{{$loop->index}}][key]"  value="{{$input['key']}}">
                                            </div>
                                        </td>

                                        <td  data-label='{{translate("Value")}}'>
                                            <div class="form-inner mb-0">
                                                <input type="text" name="custom_inputs[{{$loop->index}}][value]"  value="{{$input['value']}}">
                                            </div>
                                        </td>
                                        <td  data-label='{{translate("Attachment")}}'>
                                            <div class="form-inner mb-0">
                                                <input type="file" name="custom_inputs[{{$loop->index}}][file]"  >
                                            </div>
                                        </td>
