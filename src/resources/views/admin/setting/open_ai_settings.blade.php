                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-inner">
                                               ...
                                               <label for="ai_default_creativity"
                                                ...
                                                <select class="select2" id="ai_default_creativity" name="site_settings[ai_default_creativity]"
                                                    required>
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-inner">
                                            ...
                                            <label for="ai_default_tone"
                                                ...
                                                <select class="select2" id="ai_default_tone" name="site_settings[ai_default_tone]"
                                                    required>
