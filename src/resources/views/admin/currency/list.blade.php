                        ...
                        @if(check_permission('create_currency') || check_permission('update_currency') )
                            <div class="col-md-6 d-flex justify-content-start">
                                ...
                                @if(check_permission('create_currency'))
                                    <button type="button" data-bs-toggle="modal" data-bs-target="#currency-form" class="i-btn btn--sm success me-2 create">
                                        <i class="las la-plus me-1"></i>  {{translate('Add New')}}
                                    </button>
                                @endif
                                @if(check_permission('update_currency'))

                                    <button type="button" data-bs-toggle="modal" data-bs-target="#currency-config" class="i-btn btn--sm danger me-2 create">
