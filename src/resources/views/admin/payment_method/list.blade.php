                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-6 d-flex justify-content-start">
                        ...
                        @if(check_permission('create_method') && request()->route('type') == 'manual')
                            <a href="{{route('admin.paymentMethod.create','manual')}}"  class="i-btn btn--sm success me-2 create">
                                ...
                                <div class="table-action">
                                    ...
                                    @if(check_permission('update_method') || check_permission('delete_method'))
                                      ...
                                      @if(check_permission('update_method'))
                                        ...
                                        <a title="{{translate('Update')}}" href="{{route('admin.paymentMethod.edit',['uid' => $method->uid , 'type' => request()->route('type')])}}" class="icon-btn warning"><i class="las la-pen"></i></a>
                                      @endif
                                      @if(check_permission('delete_method') && request()->route('type') == 'manual')
                                         <a title="{{translate('Delete')}}" href="javascript:void(0);" data-href="{{route('admin.paymentMethod.destroy',$method->id)}}" class="pointer delete-item icon-btn danger">
