              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td data-label='{{translate("Account")}}'>
                      <div class="user-meta-info d-flex align-items-center gap-2">
                          <img class="rounded-circle avatar-sm" src='{{@$post->account->account_information->avatar }}' onerror="this.onerror=null; this.src='{{ route('default.image', '200x200')}}'"  alt="{{translate('Social Account Image')}}" >
