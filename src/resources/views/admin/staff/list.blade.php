                                ...
                                <div class="action">
                                    @if(request()->routeIs('admin.staff.list'))
                                        ...
                                        @if(check_permission('create_staff'))
                                            <button type="button" data-bs-toggle="modal" data-bs-target="#addStaff" class="i-btn btn--sm success me-2">
                            ...
                            <tr>
                                ...
                                <td data-label="{{translate("Name")}}">
                                    <div class="user-meta-info d-flex align-items-center gap-2">
                                        ...
                                        <img class="rounded-circle avatar-md" src="{{imageUrl(@$staff->file,"profile,admin",true)}}" alt="{{@$staff->file->name}}">
