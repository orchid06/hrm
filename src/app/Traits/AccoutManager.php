...
trait AccoutManager
{
    ...
    // public function linkedin(MediaPlatform $platform ,  array $request , string $guard = 'admin'){

    // }
    // public function youtube(MediaPlatform $platform ,  array $request , string $guard = 'admin'){

    // }


    // public function tiktok(MediaPlatform $platform ,  array $request , string $guard = 'admin'){

    //     return response_status(translate("This feature is not currently avaiable"),'error');
    // }

    // public function twitter(MediaPlatform $platform ,  array $request , string $guard = 'admin'){
